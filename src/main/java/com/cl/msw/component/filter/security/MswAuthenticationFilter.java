 ...
 */
public class MswAuthenticationFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public MswAuthenticationFilter(AuthenticationManager authenticationManager, AuthenticationSuccessHandler successHandler, AuthenticationFailureHandler failureHandler) {
